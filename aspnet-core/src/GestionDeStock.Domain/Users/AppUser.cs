...
namespace GestionDeStock.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update GestionDeStockDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update GestionDeStockEfCoreEntityExtensionMappings to extend the IdentityUser entity
